...
USTRUCT(Blueprintable)
struct FProjectileCollisionData
{
	GENERATED_BODY()
...
USTRUCT(Blueprintable)
struct FProjectileHomingMovementData
{
	GENERATED_BODY()
...
USTRUCT(Blueprintable)
struct FProjectileDamagePipelineData
{
	GENERATED_BODY()
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "Projectile|Healing")
	FProjectileHealingData HealingData;
...
public:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "Projectile|Data")
	FProjectileMovementData ProjectileMovementData;
	
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "Projectile|Data|Visuals")
	FProjectileVisualData ProjectileVisualData;
	
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "Projectile|Data|Collision")
	FProjectileCollisionData ProjectileCollisionData;
