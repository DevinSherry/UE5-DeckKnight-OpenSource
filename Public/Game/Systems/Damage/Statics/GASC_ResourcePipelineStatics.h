...
#include "GASC_ResourcePipelineStatics.generated.h"

/**
 * 
 */
UCLASS()
class GASCOURSE_API UGASC_ResourcePipelineStatics : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	static FHitContext GetHitContextCopy(const FResourceModificationContext& ResourceModContext);

	UFUNCTION(BlueprintPure, Category="Damage|Context")
	static FGameplayTagContainer GetHitTargetTagsFromDamageContext(const FResourceModificationContext& ResourceModContext);

	UFUNCTION(BlueprintPure, Category="Damage|Context")
	static FGameplayTagContainer GetHitInstigatorTagsFromDamageContext(const FResourceModificationContext& ResourceModContext);

	UFUNCTION(BlueprintPure, Category="Damage|Context")
	static FGameplayTagContainer GetHitContextTagsFromDamageContext(const FResourceModificationContext& ResourceModContext);

	UFUNCTION(BlueprintPure, Category="Damage|Context")
	static FHitResult GetHitResultCopyFromDamageContext(const FResourceModificationContext& ResourceModContext);
