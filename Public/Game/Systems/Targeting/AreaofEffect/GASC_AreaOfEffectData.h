...
public:
	/**
	 * Retrieves the radius of the area of effect as defined by the maximum distance
	 * from the center. This value is used to determine the outer boundary of the
	 * effect's influence for gameplay calculations and targeting systems.
	 *
	 * @return The radius of the area of effect.
	 */
	UFUNCTION(BlueprintPure, Category = "GASCourse|AreaOfEffect")
	float GetAOERadius();
