...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_AbilityBase);
...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_AbilityFour);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_AbilityFive);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_AssignActiveSlot);
...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Status_Block_PassiveCardEnergyXPGain);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Status_Damage_Immunity_All);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Status_Damage_Immunity_Elemental_Fire);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Status_Immortal);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Status_Invulnerable_Damage);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Status_Invulnerable_Reactions);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Status_CardEnergyCostOverride);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(Data_IncomingDamage);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Data_IncomingHealing);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Data_IncomingWeaponMana);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Data_IncomingCardEnergyXP);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Data_CachedDamage);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Data_DamageOverTime);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Data_DebugSimulated);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Data_DamageCritical);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Data_DamageResisted);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Data_HealingLifeSteal);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Data_ActiveCardEnergyXP);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Data_CardCost);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Data_DamageKilled);

UE_DECLARE_GAMEPLAY_TAG_EXTERN(DamageType_Root);
...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_OnDeathDealt);
