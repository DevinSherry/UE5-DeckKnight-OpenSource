...
void UGASC_ResourcePipelineSubsystem::Initialize(FSubsystemCollectionBase& Collection)
{
	Super::Initialize(Collection);
}

void UGASC_ResourcePipelineSubsystem::Deinitialize()
{
...
void UGASC_ResourcePipelineSubsystem::PostInitialize()
{
...
void UGASC_ResourcePipelineSubsystem::RegisterNativeHitAppliedListener(
	UObject* Listener,
...
void UGASC_ResourcePipelineSubsystem::RegisterNativeHitReceivedListener(
	UObject* Listener,
...
void UGASC_ResourcePipelineSubsystem::UnregisterNativeHitListener(UObject* Listener)
{
	if (!IsValid(Listener))
	{
		return;
...
void UGASC_ResourcePipelineSubsystem::RegisterNativeDamageAppliedListener(
	UObject* Listener,
...
void UGASC_ResourcePipelineSubsystem::RegisterNativeDamageReceivedListener(
	UObject* Listener,
...
void UGASC_ResourcePipelineSubsystem::UnregisterNativeDamageListener(UObject* Listener)
{
	if (!IsValid(Listener))
	{
		return;
...
void UGASC_ResourcePipelineSubsystem::RegisterNativeHealingAppliedListener(
	UObject* Listener,
...
void UGASC_ResourcePipelineSubsystem::RegisterNativeHealingReceivedListener(
	UObject* Listener,
...
void UGASC_ResourcePipelineSubsystem::UnregisterNativeHealingListener(UObject* Listener)
{
	if (!IsValid(Listener))
		return;
...
void UGASC_ResourcePipelineSubsystem::AddHealEventListener(
...
void UGASC_ResourcePipelineSubsystem::RemoveHealingListener(AActor* ListenerActor)
{
...
void UGASC_ResourcePipelineSubsystem::Internal_BroadcastHitApplied(const FHitContext& Context)
{
...
void UGASC_ResourcePipelineSubsystem::Internal_BroadcastHitReceived(const FHitContext& Context)
{
	// 1) Dynamic per-object listeners
...
void UGASC_ResourcePipelineSubsystem::Internal_BroadcastDamageApplied(
...
void UGASC_ResourcePipelineSubsystem::Internal_BroadcastDamageReceived(
	const FResourceModificationContext& Context)
{
	// 1) Dynamic per-object listeners
...
void UGASC_ResourcePipelineSubsystem::Internal_BroadcastHealingApplied(
	const FResourceModificationContext& Context)
{
	// 1) Dynamic per-object listeners
...
void UGASC_ResourcePipelineSubsystem::Internal_BroadcastHealingReceived(
	const FResourceModificationContext& Context)
{
	// 1) Dynamic per-object listeners
...
void UGASC_ResourcePipelineSubsystem::Internal_ForwardOnHitApplied(const FHitContext& Context)
{
	Internal_BroadcastHitApplied(Context);
}

void UGASC_ResourcePipelineSubsystem::Internal_ForwardOnHitReceived(const FHitContext& Context)
{
	Internal_BroadcastHitReceived(Context);
}

void UGASC_ResourcePipelineSubsystem::Internal_ForwardOnDamageApplied(
	const FResourceModificationContext& Context)
{
	Internal_BroadcastDamageApplied(Context);
}

void UGASC_ResourcePipelineSubsystem::Internal_ForwardOnDamageReceived(
	const FResourceModificationContext& Context)
{
	Internal_BroadcastDamageReceived(Context);
}

void UGASC_ResourcePipelineSubsystem::Internal_ForwardOnHealingApplied(
	const FResourceModificationContext& Context)
{
	Internal_BroadcastHealingApplied(Context);
}

void UGASC_ResourcePipelineSubsystem::Internal_ForwardOnHealingReceived(
	const FResourceModificationContext& Context)
{
...
bool UGASC_ResourcePipelineSubsystem::OnHitEvent(const FHitContext& HitContext)
{
...
bool UGASC_ResourcePipelineSubsystem::SendHitRequest(const FHitContext& HitContext)
{
	return OnHitEvent(HitContext);
}

void UGASC_ResourcePipelineSubsystem::RegisterActorOnHit(
	UObject* Listener,
...
void UGASC_ResourcePipelineSubsystem::UnRegisterActorOnHit(
	UObject* Listener,
	EHitEventType HitEvent,
	FOnHitApplied_Event Callback)
{
...
void UGASC_ResourcePipelineSubsystem::RegisterActorOnDamageEvent(
	UObject* Listener,
...
void UGASC_ResourcePipelineSubsystem::UnRegisterActorOnDamageEvent(
	UObject* Listener,
	EOnDamageEventType DamageEvent,
	FOnDamageApplied_Event Callback)
{
...
void UGASC_ResourcePipelineSubsystem::RegisterActorOnHealingEvent(
	UObject* Listener,
...
void UGASC_ResourcePipelineSubsystem::UnRegisterActorOnHealingEvent(
	UObject* Listener,
	EOnHealingEventType HealingEvent,
	FOnHealingApplied_Event Callback)
{
...
void UGASC_ResourcePipelineSubsystem::UnregisterOnDamageEventListener(UObject* Listener)
{
	if (!IsValid(Listener))
		return;
...
void UGASC_ResourcePipelineSubsystem::UnregisterOnHealingEventListener(UObject* Listener)
{
	if (!IsValid(Listener))
		return;
...
void UGASC_ResourcePipelineSubsystem::UnregisterOnHitEventListener(UObject* Listener)
{
	if (!IsValid(Listener))
		return;
...
FGameplayEffectSpecHandle UGASC_ResourcePipelineSubsystem::ConstructDamageEffectSpecHandle(
...
FGameplayEffectSpecHandle UGASC_ResourcePipelineSubsystem::ConstructHealingEffectSpecHandle(
	TWeakObjectPtr<AActor> Instigator,
	EGameplayEffectDurationType DurationType,
	const FDamagePipelineEffectOverTimeContext& EffectOverTimeContext)
{
...
bool UGASC_ResourcePipelineSubsystem::ApplyDamageToTarget(
...
bool UGASC_ResourcePipelineSubsystem::ApplyHealToTarget(
	TWeakObjectPtr<AActor> Target,
	TWeakObjectPtr<AActor> Instigator,
	float Heal,
...
bool UGASC_ResourcePipelineSubsystem::ApplyDamageToTarget_Internal(
	TWeakObjectPtr<AActor> Target,
	TWeakObjectPtr<AActor> Instigator,
	float Damage,
	const FDamagePipelineContext& DamageContext,
	FGameplayEffectSpecHandle DamageSpecHandle)
{
	...
	if (DamageContext.HitResult.bBlockingHit)
	{
		...
		MutableContext->ResourceModLogEntry.HitResult = DamageContext.HitResult;
...
bool UGASC_ResourcePipelineSubsystem::ApplyHealToTarget_Internal(
	TWeakObjectPtr<AActor> Target,
	TWeakObjectPtr<AActor> Instigator,
	float Heal,
	const FDamagePipelineContext& HealContext,
	FGameplayEffectSpecHandle HealSpecHandle)
{
	...
	{
		//MutableContext->AddHitResult(DamageContext.HitResult);
		MutableContext->ResourceModLogEntry.HitResult = HealContext.HitResult;
...
bool UGASC_ResourcePipelineSubsystem::ApplyDamageToTargetDataHandle(
...
bool UGASC_ResourcePipelineSubsystem::ApplyHealToTargetDataHandle(
	const FGameplayAbilityTargetDataHandle& TargetHandle,
	TWeakObjectPtr<AActor> Instigator,
	float Heal,
...
bool UGASC_ResourcePipelineSubsystem::ApplyDamageOverTimeToTarget(
	TWeakObjectPtr<AActor> Target,
	TWeakObjectPtr<AActor> Instigator,
	float Damage,
	const FDamagePipelineContext& DamageContext,
...
bool UGASC_ResourcePipelineSubsystem::ApplyHealOverTimeToTarget(
	TWeakObjectPtr<AActor> Target,
	TWeakObjectPtr<AActor> Instigator,
	float Heal,
	const FDamagePipelineContext& HealContext,
...
bool UGASC_ResourcePipelineSubsystem::ApplyPhysicalDamageToTarget(
	TWeakObjectPtr<AActor> Target,
	TWeakObjectPtr<AActor> Instigator,
	float Damage,
...
bool UGASC_ResourcePipelineSubsystem::ApplyFireDamageToTarget(
	TWeakObjectPtr<AActor> Target,
	TWeakObjectPtr<AActor> Instigator,
	float Damage,
	const FHitResult& HitResult,
